...
if (isset($_POST['submit'])) {   
    ...
    $email_from = "enquiry1@gtiaindia.org";
    ...
    $email_body .= "<tr><td style='text-align:right' bgcolor='#EBF2F6'>Course :</td><td style='text-align:left' bgcolor='#FFFFFF'><span>$course</span></td></tr>";
    ...
    // Multiple recipients
    $to = "enquiry1@gtiaindia.org, enquiry.gtiaindialeads@gmail.com"; // Add both emails here
